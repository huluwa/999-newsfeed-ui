...
//        if(Launcher.LOGD)Log.d("oms2.5Launcher.ApplicationInfo", "ApplicationInfo sourceDir "+sourceDir);
...
//      	}
    ...
    public ApplicationInfo(ResolveInfo info, IconCache iconCache, boolean isNeedSetCategory) {
        this.componentName = new ComponentName(
                info.activityInfo.applicationInfo.packageName,
                info.activityInfo.name);
