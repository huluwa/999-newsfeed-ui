...
public class Folder extends LinearLayout implements DragSource,
	...
	protected void onFinishInflate() {
		...
		mCloseImageView = (ImageView) findViewById(R.id.close_folder);
		mCloseImageView.setBackgroundResource(R.drawable.ic_close_folder);
		mCloseImageView.setOnClickListener(this);

		mFloderNameTextView = (TextView)findViewById(R.id.folder_name_show);
		
		
		mEditimageView = (ImageView) findViewById(R.id.folder_rename);
		mEditimageView.setBackgroundResource(R.drawable.ic_edit_folder_name);
	...
	void bind(FolderInfo info) {
		mInfo = info;
		mFloderNameTextView.setText(info.title);
	}
}
