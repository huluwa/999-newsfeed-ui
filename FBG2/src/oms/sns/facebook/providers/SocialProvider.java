...
{
	    public static final Uri CONTENT_URI = Uri.parse("content://oms.sns.facebook.providers.SocialProvider");
	    ...
	    private static final String Authorities = "oms.sns.facebook.providers.SocialProvider";
