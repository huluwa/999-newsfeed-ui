...
import oms.sns.facebook.providers.SocialORM.FollowCol;
import oms.sns.facebook.providers.SocialORM.PhonebookCol;
import oms.sns.facebook.ui.FacebookMailActivity;
...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    {	        
        ...
        if(fortwitter == false)
        {
	        ...
	        Uri CONTENT_URI = Uri.parse("content://oms.sns.facebook.providers.SocialProvider/facebookusers");
            cursor = SqliteWrapper.query(mContext, mContentResolver,CONTENT_URI, PROJECTION_SMARTLEARNER, " name like '%"+arg+"%' " , null, null);
	        
    	    if(cursor == null || cursor.moveToFirst() == false)
    	    {
    	        CONTENT_URI = Uri.parse("content://oms.sns.facebook.providers.SocialProvider/phonebook");
        ...
        {
        	String[] args = new String[]{arg};
	        Uri CONTENT_URI = Uri.parse("content://oms.sns.facebook.providers.SocialProvider/follow");
