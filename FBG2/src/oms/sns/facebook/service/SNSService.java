...
import oms.sns.facebook.api.SocialServiceInterface;
...
import oms.sns.facebook.service.FacebookSyncHelper;
...
import oms.sns.facebook.ui.FacebookMessageActivity;
import oms.sns.facebook.ui.FacebookLoginActivity;
import oms.sns.facebook.ui.FacebookSettingPreference;
import oms.sns.facebook.ui.FacebookStatusUpdateActivity;
...
public class SNSService extends Service implements SocialServiceInterface, AccountListener
{
	...
	@Override public void onCreate() 
    {
        ...
        IntentFilter filter = new IntentFilter("oms.sns.facebook.getsession");
	...
	public void onStart(Intent intent, int startId)
	{
		...
		if(intent.getAction() != null)
		{
			...
			if(intent.getAction().equals("oms.sns.facebook.intent.action.FACEBOOK_USER"))
			{
			...
			else if(intent.getAction().equals("oms.sns.facebook.intent.action.FACEBOOK_PHONEBOOK"))
			{
			...
			else if(intent.getAction().equals("oms.sns.facebook.intent.action.MAIL_CHECK"))
			{
			...
			else if(intent.getAction().equals("oms.sns.facebook.intent.action.reset.FACEBOOK_PHONEBOOK"))
			{
			...
			else if(intent.getAction().equals("oms.sns.facebook.intent.action.reset.MAIL_CHECK"))
			{
