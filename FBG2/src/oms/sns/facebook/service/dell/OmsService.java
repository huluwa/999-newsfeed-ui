...
import oms.sns.facebook.service.ServiceInterface;
import oms.sns.facebook.service.dell.OmsTask.EventAddTask;
import oms.sns.facebook.service.dell.OmsTask.TaskListener;
...
public class OmsService implements  ServiceInterface, TaskListener, AccountListener, NetworkConnectionListener
{
	...
	/*
	 * For login progess
	 * @see oms.sns.facebook.service.ServiceInterface#afterLogin()
	 */
