...
public class Utility {
    ...
    public static HttpHeaderFactory getAuthorization() {
        return mAuth;
    }
    
    public static String getAuthorization(String method, String url, WeiboParameters params, Token token,  HttpURLConnection connection)
    {
    	String authHeader = "";
    	if (!isBundleEmpty(params) && mAuth != null) {
    		
			try {
				authHeader = mAuth.getWeiboAuthHeader(method, url, params,
    ...
    public static String openUrlWithResponse(Context context, String url, String method,
            WeiboParameters params, String file, Token token) throws WeiboException {
        String result = "";
        try {
            HttpClient client = getNewHttpClient(context);
