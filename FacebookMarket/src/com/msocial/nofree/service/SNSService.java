...
import com.msocial.nofree.api.SocialServiceInterface;
...
import com.msocial.nofree.service.FacebookSyncHelper;
import com.msocial.nofree.service.dell.ContactHelper;
import com.msocial.nofree.service.dell.OmsService;
import com.msocial.nofree.service.dell.OmsTask;
import com.msocial.nofree.service.dell.OmsTask.ContactSyncTask;
import com.msocial.nofree.service.dell.OmsTask.EventAddTask;
import com.msocial.nofree.service.dell.OmsTask.EventSyncTask;
import com.msocial.nofree.service.dell.OmsTask.LookupTask;
import com.msocial.nofree.ui.AccountListener;
import com.msocial.nofree.ui.FacebookBaseActivity;
import com.msocial.nofree.ui.FacebookMessageActivity;
import com.msocial.nofree.ui.FacebookLoginActivity;
import com.msocial.nofree.ui.FacebookSettingPreference;
import com.msocial.nofree.ui.FacebookStatusUpdateActivity;
import com.msocial.nofree.ui.SyncAddressBookHelper;
...
public class SNSService extends Service implements SocialServiceInterface, AccountListener
{
	...
	public static String systemvalue="16m";
	static 
	{
	    //for emulator
	...
	@Override public void onCreate() 
    {
        ...
        /*
        String dvm = SystemProperties.get("dalvik.vm.heapsize", "16m");
        systemvalue = dvm;
        if(dvm.equalsIgnoreCase("16m") || dvm.equalsIgnoreCase("24m") || dvm.equalsIgnoreCase("32m"))
        {
        	Log.d(TAG, "DVM is too small="+dvm);
            SystemProperties.set("dalvik.vm.heapsize", "48m");
        }
        Log.d(TAG, "DVM is dvm="+dvm);
        */
        ...
        IntentFilter filter = new IntentFilter("com.msocial.nofree.getsession");
	...
	public void onStart(Intent intent, int startId)
	{
		...
		if(intent.getAction() != null)
		{
			...
			if(intent.getAction().equals("com.msocial.nofree.intent.action.FACEBOOK_USER"))
			{
			...
			else if(intent.getAction().equals("com.msocial.nofree.intent.action.FACEBOOK_PHONEBOOK"))
			{
			...
			else if(intent.getAction().equals("com.msocial.nofree.intent.action.MAIL_CHECK"))
			{
			...
			else if(intent.getAction().equals("com.msocial.nofree.intent.action.reset.FACEBOOK_PHONEBOOK"))
			{
			...
			else if(intent.getAction().equals("com.msocial.nofree.intent.action.reset.MAIL_CHECK"))
			{
