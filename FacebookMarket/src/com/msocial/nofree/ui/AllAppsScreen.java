...
public class AllAppsScreen extends ViewGroup {
    ...
    private TitleActionListener tl;
    ...
    public void initAllAppsScreens() {        
        ...
        mMaximumVelocity = 2000;//configuration.getScaledMaximumFlingVelocity();
    }
	...
	private void setTitle(int nIndex)
	{
		if(tl != null)
		{
			tl.setPageTitle(nIndex);
		}
	}
