...
import com.msocial.nofree.ui.adapter.FacebookSelectUserAdapter;
import com.msocial.nofree.ui.view.FacebookSelectUserItemView;
...
public class FacebookUserSelectActivity extends FacebookBaseActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
       ...
       View facebook_select_span = findViewById(R.id.facebook_select_span);
       facebook_select_span.setVisibility(View.VISIBLE);
       
       Button facebook_user_select_button = (Button)findViewById(R.id.facebook_user_select_button);
       facebook_user_select_button.setOnClickListener(new View.OnClickListener() {
		   public void onClick(View arg0) {
		       selectDone();
		   }
	   });
       
       Button facebook_user_cancel = (Button)findViewById(R.id.facebook_user_cancel);
       facebook_user_cancel.setOnClickListener(new View.OnClickListener() {
		   public void onClick(View arg0) {
		       finish();
		   }
	   });
