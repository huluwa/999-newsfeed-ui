...
import com.msocial.nofree.providers.SocialORM.FollowCol;
import com.msocial.nofree.providers.SocialORM.PhonebookCol;
import com.msocial.nofree.ui.FacebookMailActivity;
...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    {	        
        ...
        if(fortwitter == false)
        {
	        ...
	        Uri CONTENT_URI = Uri.parse("content://com.msocial.nofree.providers.SocialProvider/facebookusers");
    	    ...
    	    {
    	        CONTENT_URI = Uri.parse("content://com.msocial.nofree.providers.SocialProvider/phonebook");
        ...
        {
        	String[] args = new String[]{arg};
	        Uri CONTENT_URI = Uri.parse("content://com.msocial.nofree.providers.SocialProvider/follow");
