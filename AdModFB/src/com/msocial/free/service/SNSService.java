...
import com.msocial.free.api.SocialServiceInterface;
...
import com.msocial.free.service.dell.OmsTask.ContactSyncTask;
import com.msocial.free.service.dell.OmsTask.EventAddTask;
import com.msocial.free.service.dell.OmsTask.EventSyncTask;
import com.msocial.free.service.dell.OmsTask.LookupTask;
import com.msocial.free.ui.AccountListener;
import com.msocial.free.ui.FacebookBaseActivity;
import com.msocial.free.ui.FacebookMessageActivity;
import com.msocial.free.ui.FacebookLoginActivity;
import com.msocial.free.ui.FacebookSettingPreference;
import com.msocial.free.ui.FacebookStatusUpdateActivity;
...
public class SNSService extends Service implements SocialServiceInterface, AccountListener
{
	...
	@Override public void onCreate() 
    {
        ...
        */
        ...
        IntentFilter filter = new IntentFilter("com.msocial.free.getsession");
	...
	public void onStart(Intent intent, int startId)
	{
		...
		if(intent.getAction() != null)
		{
			...
			if(intent.getAction().equals("com.msocial.free.intent.action.FACEBOOK_USER"))
			{
			...
			else if(intent.getAction().equals("com.msocial.free.intent.action.FACEBOOK_PHONEBOOK"))
			{
			...
			else if(intent.getAction().equals("com.msocial.free.intent.action.MAIL_CHECK"))
			{
			...
			else if(intent.getAction().equals("com.msocial.free.intent.action.reset.FACEBOOK_PHONEBOOK"))
			{
			...
			else if(intent.getAction().equals("com.msocial.free.intent.action.reset.MAIL_CHECK"))
			{
