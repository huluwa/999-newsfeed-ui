package com.msocial.free.providers;
...
{
	    public static final Uri CONTENT_URI = Uri.parse("content://com.msocial.free.providers.SocialProvider");
	    ...
	    private static final String Authorities = "com.msocial.free.providers.SocialProvider";
	    ...
	    private static class DatabaseHelper extends SQLiteOpenHelper 
	    {
	        ...
	        public void onCreate(SQLiteDatabase db) {
	            ...
	            try{
    	            ...
    	            db.execSQL("INSERT INTO settings (name, value) VALUES(\"twitter_use_https_connection\", \"1\");");
    	            db.execSQL("INSERT INTO settings (name, value) VALUES(\"facebook_use_https_connection\", \"1\");");
