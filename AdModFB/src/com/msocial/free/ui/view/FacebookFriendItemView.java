...
import com.msocial.free.ui.FacebookGroupDetailsActivity;
import com.msocial.free.ui.FacebookMailDetailActivity;
import com.msocial.free.ui.FacebookNewFriendsActivity;
...
public class FacebookFriendItemView extends SNSItemView {
	...
	public FacebookFriendItemView(Context ctx, AttributeSet attrs) 
	{
		...
		mContext = ctx;
		if(FacebookGroupDetailsActivity.class.isInstance(mContext)){
			fromGroupMember = true;
		}else{
