 ...
 * 
 */
public class Relationship extends FacebookObject<Relationship.Field>
{
	private static final long serialVersionUID = 1L;

	public Boolean areFriends()
	{
		return getBoolean( Field.ARE_FRIENDS );
	}

	public Long getUserId1()
	{
		return getLong( Field.UID1 );
	}

	public Long getUserId2()
	{
		return getLong( Field.UID2 );
	}
