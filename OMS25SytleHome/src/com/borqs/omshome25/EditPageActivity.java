...
import com.borqs.omshome25.screenmanager.*;
import com.borqs.omshome25.screenmanager.AdapterView.OnItemClickListener;
import com.borqs.omshome25.screenmanager.AdapterView.OnItemLongClickListener;
import com.borqs.omshome25.screenmanager.AdapterView.OnItemSelectedListener;
...
//        	    final ContentResolver cr = v.getContext().getContentResolver();
        	    Launcher.setSettingsIntValue(EditPageActivity.this, LauncherORM.default_page_index, mGLView.getCurPageIndex());
...
//        Log.d(TAG,"#########scaleHeight="+scaleHeight+"==scaleWidth="+scaleWidth);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if(action.equals(Launcher.INTENT_CREATE_BITMAP_OK))
            {
               ...
               synchronized(mPageImageList)
               {
                   ...
                   for(int i=0;i<mPageImageList.size()&& i<imageList.size();i++)
                   {  
    ...
    static final int HOME_SETTING = 100;
    @Override
