...
import com.borqs.omshome25.Workspace.MyBounceInterpolator;
...
//    private Workspace.MyBounceInterpolator mScrollInterpolator;
...
//    boolean needrecord =false;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
       if(Launcher.LOGD) Log.d(TAG,"onInterceptTouchEvent ev:"+ev.getAction()+", at:"+SystemClock.uptimeMillis());
...
//            		}
    ...
    void snapToScreenWithVelocityX(int whichScreen, int velocityX) {
        ...
        if(mLauncher.dockStyle==1){
        	...
        	if(pageIndicator!=null)pageIndicator.drawPageIndicatorWith3Point(mNextScreen,getChildCount());
            if(mLinePageIndicator!=null)mLinePageIndicator.refreshPosition(pageIndicatorRawWidth, pageIndicatorRawHeight, mLauncher.screenWidth, mLauncher.screenHeight, mNextScreen, getChildCount());
        }
...
//    		}, 3000);
    ...
    static final float distance = 0.8f;
