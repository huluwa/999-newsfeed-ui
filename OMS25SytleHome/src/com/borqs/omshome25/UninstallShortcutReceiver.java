...
public class UninstallShortcutReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_UNINSTALL_SHORTCUT =
            "com.android.launcher.action.UNINSTALL_SHORTCUT";

    private Launcher mLauncher;
    
    public UninstallShortcutReceiver(Launcher launcher) {
    	mLauncher = launcher;
    }
    
    public void onReceive(Context context, Intent data) {
        if(Launcher.LOGD)Log.d(TAG,"onReceive intent action:"+data.getAction());
        ...
        if (intent != null && name != null) {
            ...
            if(null != mLauncher && false == mLauncher.getIsRestoreBackupWidget()){
            	if (changed) {
