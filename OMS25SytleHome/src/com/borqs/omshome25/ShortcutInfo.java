...
class ShortcutInfo extends ItemInfo {
    ...
    int newIndex = -1;//add for auto move child which was dragged over to another screen
    ...
    void onAddToDatabase(ContentValues values) {
    	if(Launcher.LOGD)Log.d("Launcher.ShortcutInfo", "onAddToDatabase title:"+title);
