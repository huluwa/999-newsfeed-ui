 ...
 * @author Gino Miceli
 */
public class FacebookXmlException extends FacebookClientException
{
	...
	public FacebookXmlException( String message, Throwable cause )
	{
		super( message, cause );
	}

	public FacebookXmlException( String message )
	{
		super( message );
	}

	public FacebookXmlException( Throwable cause )
	{
		super( cause );
	}
}
