...
import com.msocial.freefb.providers.SocialORM.FollowCol;
import com.msocial.freefb.providers.SocialORM.PhonebookCol;
import com.msocial.freefb.ui.FacebookMailActivity;
...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    {	        
        ...
        if(fortwitter == false)
        {
	        ...
	        Uri CONTENT_URI = Uri.parse("content://com.msocial.freefb.providers.SocialProvider/facebookusers");
	        cursor = mContentResolver.query(CONTENT_URI, PROJECTION_SMARTLEARNER, " name like '%"+arg+"%' ", null, null);
            //cursor = SQLiteQuery.query(mContext, mContentResolver,CONTENT_URI, PROJECTION_SMARTLEARNER, " name like '%"+arg+"%' " , null, null);
	        
    	    if(cursor == null || cursor.moveToFirst() == false)
    	    {
    	        CONTENT_URI = Uri.parse("content://com.msocial.freefb.providers.SocialProvider/phonebook");
    	        cursor = mContentResolver.query(CONTENT_URI, PROJECTION_SMARTLEARNER, " email like '%"+arg+"%' ", null, null);
        ...
        {
        	String[] args = new String[]{arg};
	        Uri CONTENT_URI = Uri.parse("content://com.msocial.freefb.providers.SocialProvider/follow");
	        ...
	        Cursor cursor = mContentResolver.query(CONTENT_URI, PROJECTION_SMARTLEARNER, " name like '%"+arg+"%' and type = 0 ", null, null);
