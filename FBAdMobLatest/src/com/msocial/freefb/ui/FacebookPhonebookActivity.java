...
import com.msocial.freefb.service.dell.ContactID;
import com.msocial.freefb.service.dell.ContactInternal;
import com.msocial.freefb.ui.AccountListener.AccountManager;
import com.msocial.freefb.ui.adapter.FacebookPhoneBookAdapter;
import com.msocial.freefb.ui.lisenter.SyncFacebookAdapter;
        ...
        public void handleMessage(Message msg) 
        {
            switch(msg.what)
            {
	            ...
	            case GET_FRIEND_USER_INFO:
	            {
	                ...
	                i.setAction("com.msocial.freefb.intent.action.FACEBOOK_USER");
                ...
                case FACEBOOK_PHONEBOOK_GET:
                {
                	if(msg.getData().getBoolean("RESULT", false)== true)
	            	{
                        ...
                        Intent i = new Intent();
                        i.setClassName("com.msocial.freefb", "com.msocial.freefb.service.SNSService");
                        i.setAction("com.msocial.freefb.intent.action.FACEBOOK_PHONEBOOK");
                        i.putExtra("callback", backMsg);
                        PendingIntent userpi = PendingIntent.getService(mContext.getApplicationContext(), 0, i, PendingIntent.FLAG_CANCEL_CURRENT);
                        alarmMgr.set(AlarmManager.RTC_WAKEUP, 10, userpi);
                        */
