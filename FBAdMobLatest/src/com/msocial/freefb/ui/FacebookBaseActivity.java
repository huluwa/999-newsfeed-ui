...
import com.msocial.freefb.providers.SocialORM.Account;
import com.msocial.freefb.service.FacebookLoginHelper;
import com.msocial.freefb.ui.AccountListener.AccountManager;
import com.msocial.freefb.ui.ActivityBase.TitleListener;
import com.msocial.freefb.ui.FacebookAlbumActivity.FacebookAlbumItemView;
import com.msocial.freefb.ui.FacebookAlbumViewActivity.AlbumItemView;
import com.msocial.freefb.ui.view.CommentItemView;
import com.msocial.freefb.ui.FacebookNotificationManActivity.NotesItemView;
import com.msocial.freefb.ui.view.FacebookEventItemView;
import com.msocial.freefb.ui.view.FacebookFindFriendItemView;
...
import com.msocial.freefb.util.StatusNotification;
...
public abstract class FacebookBaseActivity extends ActivityBase implements
    ...
    protected static final String ACTION_CHECK_CONTECT = "com.msocial.freefb.intent.action.ACTION_CHECK_CONTECT";
...
//            	}
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        else if (DashBoardActivity.class.isInstance(this) || FacebookProfileActivity.class.isInstance(this)) 
        {
    ...
    public boolean onContextItemSelected(MenuItem item) 
    {
        ...
        switch (item.getItemId()) 
        {
	        ...
	        {
	            if (FacebookProfileActivity.class.isInstance(this) || DashBoardActivity.class.isInstance(this)) {
    ...
    public void removeShortCut(FacebookUser.SimpleFBUser user){  
    	if (DashBoardActivity.class.isInstance(this) || FacebookProfileActivity.class.isInstance(this)) {
	        user.isShoutcut = false;
	        orm.updateFacebookUserShortCut(user, false);
	        refreshShortCut();
        }        
    ...
    public void removeAllShortcut()
    {
    	 AlertDialog dialog = new AlertDialog.Builder(this).setTitle(
	        ...
	        getString(R.string.delete_all_shortcut)).setPositiveButton(
	        getString(R.string.sns_ok),
	        new DialogInterface.OnClickListener() {
	            public void onClick(DialogInterface dialog, int whichButton) {
	            	if (DashBoardActivity.class.isInstance(this) || FacebookProfileActivity.class.isInstance(FacebookBaseActivity.this)) 
		        	{
		        		orm.deleteFacebookShortCut();		                
		                refreshShortCut();
		            }
    ...
    protected void shareAdFreeFacebookApp()
    {
    	try {
    		Intent intent = new Intent(Intent.ACTION_VIEW);
    		intent.setData(Uri.parse("market://search?q=com.msocial.nofree"));
		    startActivity(intent);
		}catch(Exception ne){
	        Intent send = new Intent(Intent.ACTION_SEND);
	        send.setType("text/plain");                 
	        send.putExtra(Intent.EXTRA_TEXT,  "http://market.android.com/details?id=com.msocial.nofree");                                  
	        
	        try {
	            startActivity(Intent.createChooser(send, "Ad Free Version"));
    ...
    protected void shareFacebookApp()
    {
        Intent send = new Intent(Intent.ACTION_SEND);
        send.setType("text/plain");                 
        send.putExtra(Intent.EXTRA_TEXT,  "http://market.android.com/details?id=com.msocial.freefb");                                  
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        else if (DashBoardActivity.class.isInstance(this) || FacebookProfileActivity.class.isInstance(this)) 
        {
            ...
            //menu.findItem(R.id.facebook_menu_settings).setVisible(true);
            //menu.findItem(R.id.facebook_menu_status_update).setVisible(true); 
            menu.findItem(R.id.facebook_menu_share_ad_free_app).setVisible(true);
        } 
        else if (FacebookAccountActivity.class.isInstance(this)) 
        {
    ...
    public boolean onOptionsItemSelected(MenuItem item) 
    {
        switch (item.getItemId()) 
        {
	        ...
	        case R.id.facebook_menu_share_ad_free_app:
	        {
	        	shareAdFreeFacebookApp();
	        	break;
	        }
    ...
    public void addshortCut(FacebookUser.SimpleFBUser user) {
        user.isShoutcut = true;
        orm.updateFacebookUserShortCut(user, true);
    }
