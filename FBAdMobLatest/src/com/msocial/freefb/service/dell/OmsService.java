...
import com.msocial.freefb.service.ServiceInterface;
import com.msocial.freefb.service.dell.OmsTask.EventAddTask;
import com.msocial.freefb.service.dell.OmsTask.TaskListener;
...
public class OmsService implements  ServiceInterface, TaskListener, AccountListener, NetworkConnectionListener
{
	...
	/*
	 * For login progess
	 * @see com.msocial.freefb.service.ServiceInterface#afterLogin()
	 */
