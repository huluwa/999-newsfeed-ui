...
import com.msocial.freefb.api.SocialServiceInterface;
...
import com.msocial.freefb.service.FacebookSyncHelper;
import com.msocial.freefb.service.dell.ContactHelper;
import com.msocial.freefb.service.dell.OmsService;
import com.msocial.freefb.service.dell.OmsTask;
import com.msocial.freefb.service.dell.OmsTask.ContactSyncTask;
import com.msocial.freefb.service.dell.OmsTask.EventAddTask;
import com.msocial.freefb.service.dell.OmsTask.EventSyncTask;
import com.msocial.freefb.service.dell.OmsTask.LookupTask;
...
import com.msocial.freefb.ui.FacebookLoginActivity;
import com.msocial.freefb.ui.FacebookSettingPreference;
import com.msocial.freefb.ui.FacebookStatusUpdateActivity;
import com.msocial.freefb.ui.SyncAddressBookHelper;
...
public class SNSService extends Service implements SocialServiceInterface, AccountListener
{
	...
	public void onStart(Intent intent, int startId)
	{
		...
		if(intent.getAction() != null)
		{
			...
			if(intent.getAction().equals("com.msocial.freefb.intent.action.FACEBOOK_USER"))
			{
			...
			else if(intent.getAction().equals("com.msocial.freefb.intent.action.FACEBOOK_PHONEBOOK"))
			{
			...
			else if(intent.getAction().equals("com.msocial.freefb.intent.action.MAIL_CHECK"))
			{
			...
			else if(intent.getAction().equals("com.msocial.freefb.intent.action.reset.FACEBOOK_PHONEBOOK"))
			{
			...
			else if(intent.getAction().equals("com.msocial.freefb.intent.action.reset.MAIL_CHECK"))
			{
