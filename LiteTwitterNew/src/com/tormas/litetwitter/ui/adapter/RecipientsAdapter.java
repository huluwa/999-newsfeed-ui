...
import com.tormas.litetwitter.providers.SocialORM.FacebookUsersCol;
import com.tormas.litetwitter.providers.SocialORM.FollowCol;
import com.tormas.litetwitter.providers.SocialORM.PhonebookCol;
...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    {	        
        ...
        if(fortwitter == false)
        {
	        ...
	        Uri CONTENT_URI = Uri.parse("content://com.tormas.litetwitter.providers.SocialProvider/facebookusers");
	        cursor = mContentResolver.query(CONTENT_URI, PROJECTION_SMARTLEARNER, " name like '%"+arg+"%' ", null, null);
	        
    	    if(cursor == null || cursor.moveToFirst() == false)
    	    {
    	        CONTENT_URI = Uri.parse("content://com.tormas.litetwitter.providers.SocialProvider/phonebook");
        ...
        {
        	String[] args = new String[]{arg};
	        Uri CONTENT_URI = Uri.parse("content://com.tormas.litetwitter.providers.SocialProvider/follow");
