...
class LauncherSettings {
    ...
    static final class Favorites implements BaseLauncherColumns {
        ...
        static final Uri CONTENT_SETTING_URI_NO_NOTIFICATION = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_SETTINGS +
                "?" + LauncherProvider.PARAMETER_NOTIFY + "=false");
        
        static final Uri CONTENT_categoryname_URI_NO_NOTIFICATION = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_CATEGORY_name +
                "?" + LauncherProvider.PARAMETER_NOTIFY + "=false");
        
        static final Uri CONTENT_category_URI_NO_NOTIFICATION = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_CATEGORY +
                "?" + LauncherProvider.PARAMETER_NOTIFY + "=false");
        /**
        ...
        /**
         * The favorite is a web widget
         */
        static final int ITEM_TYPE_WEBWIDGET = 5;
