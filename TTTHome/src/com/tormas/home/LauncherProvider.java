...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.tormas.home.settings";
    
    static final String TABLE_FAVORITES = "favorites";
    static final String TABLE_SETTINGS = "settings";
    static final String PARAMETER_NOTIFY    = "notify";    
    static final String TABLE_CATEGORY      = "category";
    static final String TABLE_CATEGORY_name = "categoryname";
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private int getScreenCount() {
            ...
            try {
                counts = android.provider.Settings.System.getInt(cr, Workspace.TAG_SCREEN_NUM);
            } catch (Exception e) {}
