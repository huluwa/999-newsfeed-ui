...
public class AllAppsScreenLayout
    ...
    private boolean fisttimecreate = true;
	@Override
    protected void onFinishInflate() {
        ...
        try {
            ...
            mAllAppsScreen.setOnSelectCategoryListener(this);
            ...
            mCategoryNameView.setOnClickListener(new View.OnClickListener() {				
				public void onClick(View arg0) {
					//selectNexCategory(true);
				}
			});
            
            mCategoryView = (TextView)findViewById(R.id.all_apps_category);
            mCategoryEditView = (ImageView)findViewById(R.id.all_apps_edit);
            mCategoryEditView.setOnClickListener(new View.OnClickListener() {				
    ...
    private void refreshApps(){
    	...
    	if((currentCategory == Category.CATEGORY_3RDAPP && appsCount>0) || (currentCategory >= Category.CATEGORY_Entertainment && currentCategory <= Category.CATEGORY_SHORTCUT)){
    		if(currentCategory == Category.CATEGORY_3RDAPP){
    			mCategoryEditView.setImageResource(R.drawable.ic_allapps_uninstall_the3rdapps);
    		}else{
    			mCategoryEditView.setImageResource(R.drawable.ic_edit_list_default_rail);
    		}
    	...
    	for(int i=0; i<appsCount; i++){
    		...
    		//textView.setBackgroundResource(R.drawable.allapp_bg);
    ...
    private void refreshEditApps(){
    	...
    	if((currentCategory >= Category.CATEGORY_Entertainment && currentCategory <= Category.CATEGORY_SHORTCUT) && mAllAppsList.size() == 0){
    		mCategoryEditView.setVisibility(View.GONE);
    	}else{
    		mCategoryEditView.setVisibility(View.VISIBLE);
    		mCategoryEditView.setImageResource(R.drawable.ic_allapp_editback);
    	}
    	isEditModel = true;
    	...
    	if((currentCategory >Category.CATEGORY_CUSTOMIZE && currentCategory <= Category.CATEGORY_SHORTCUT) && (appsCount < Category.allapps.size() || appsCount == 0)){
    		if(mAllAppsScreen.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
	...
	public void onClick(View v) {
        ...
        if (tag instanceof ApplicationInfo) {
        	...
        	if(isEditModel){
        		if(currentCategory >= Category.CATEGORY_Entertainment && currentCategory <= Category.CATEGORY_SHORTCUT){
        ...
        }else if(tag instanceof Integer && (((Integer)tag).intValue() > Category.CATEGORY_CUSTOMIZE && ((Integer)tag).intValue() <= Category.CATEGORY_SHORTCUT)){
	...
	public boolean selectNexCategory(boolean next) {
		if(mLoadingBar.getVisibility() == View.VISIBLE){
			return false;
		}
		...
		if(next)
		{
			...
			case Category.CATEGORY_ALLAPP:
				...
				break;
			case Category.CATEGORY_3RDAPP:
				category = Category.CATEGORY_SHORTCUT;
					break;
			case Category.CATEGORY_SHORTCUT:
				category = Category.CATEGORY_Entertainment;
				break;
			case Category.CATEGORY_Entertainment:
				category = Category.CATEGORY_Information;
				break;
			case Category.CATEGORY_Information:
				category = Category.CATEGORY_Tools;
				break;
			case Category.CATEGORY_Tools:
				category = Category.CATEGORY_ALLAPP;
				break;
			}
		}
		else
		...
		displayAppsByCategory(category, false);
...
//    	final ActionItem system = new ActionItem();
//    	final ActionItem carrier = new ActionItem();
//    	final ActionItem oem = new ActionItem();
//    	final ActionItem the3rd = new ActionItem();
//    	final ActionItem recentuse = new ActionItem();
//    	final ActionItem shortcut = new ActionItem();
//    	Log.d(TAG, "initCategory Category.nameAll:"+Category.nameAll);
//    	
//    	recentuse.setTitle(Category.nameRecentUse);
//    	recentuse.setIcon(Category.drawableRecentUse);
//    	recentuse.setOnClickListener(new OnClickListener() {			
//			public void onClick(View v) {
//				qa.dismiss();
//				if(currentCategory == Category.CATEGORY_RECENTUSE)
//					return; 
//				currentCategory = Category.CATEGORY_RECENTUSE;
//				mCategoryNameView.setText(Category.nameRecentUse);
//				refreshAppsWithCategory(Category.recentuseapps);
//			}
//		});
//		
//		all.setTitle(Category.nameAll);
//		all.setIcon(Category.drawableAll);
...
//				
//				currentCategory = Category.CATEGORY_ALLAPP;
//				mCategoryNameView.setText(Category.nameAll);
//				refreshAppsWithCategory(Category.allapps);
//			}
//		});
//		
//		
//		system.setTitle(Category.nameSystem);
//		system.setIcon(Category.drawableSystem);
//		system.setOnClickListener(new OnClickListener() {			
//			public void onClick(View v) {
//				qa.dismiss();
//				if(currentCategory == Category.CATEGORY_SYSTEMAPP)
//					return; 
//				currentCategory = Category.CATEGORY_SYSTEMAPP;
//				mCategoryNameView.setText(Category.nameSystem);
//				refreshAppsWithCategory(Category.systemapps);
//			}
//		});
//		
//		shortcut.setTitle(Category.nameShortcut);
//		shortcut.setIcon(Category.drawableShortcut);
...
//				mCategoryNameView.setText(Category.nameShortcut);
//				refreshAppsWithCategory(Category.shortcutapps);
//			}
//		});
//		
//        carrier.setTitle(Category.nameCarrier);
//        carrier.setIcon(Category.drawableCarrier);
//        carrier.setOnClickListener(new OnClickListener() {			
//			public void onClick(View v) {
//				qa.dismiss();
//				if(currentCategory == Category.CATEGORY_CARRIERAPP)
//					return; 
//				currentCategory = Category.CATEGORY_CARRIERAPP;
//				mCategoryNameView.setText(Category.nameCarrier);
//				refreshAppsWithCategory(Category.carrierapps);
//			}
//		});
//		
//		oem.setTitle(Category.nameOem);
//		oem.setIcon(Category.drawableOem);
//		oem.setOnClickListener(new OnClickListener() {			
//			public void onClick(View v) {
//				qa.dismiss();
//				if(currentCategory == Category.CATEGORY_OEMAPP)
//					return; 
//				currentCategory = Category.CATEGORY_OEMAPP;
//				mCategoryNameView.setText(Category.nameOem);
//				refreshAppsWithCategory(Category.oemapps);
//			}
//		});
//		
//		the3rd.setTitle(Category.nameThe3rd);
//		the3rd.setIcon(Category.drawableThe3rd);
//		the3rd.setOnClickListener(new OnClickListener() {			
//			public void onClick(View v) {
//				qa.dismiss();
//				if(currentCategory == Category.CATEGORY_3RDAPP)
//					return; 
//				currentCategory = Category.CATEGORY_3RDAPP;
//				mCategoryNameView.setText(Category.nameThe3rd);
//				mCategoryEditView.setVisibility(View.VISIBLE);
//				refreshAppsWithCategory(Category.the3rdapps);
//			}
//		});
//		{
//	qa = new QuickAction(mCategoryView);
//	qa.addActionItem(all);
//	qa.addActionItem(system);
//	qa.addActionItem(the3rd);
//	qa.addActionItem(shortcut);
