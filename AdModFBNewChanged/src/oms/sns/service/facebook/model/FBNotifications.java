...
public class FBNotifications 
{
	public static class NotifyType
	{
		...
		public final static int FriendRequests=1;
		public final static int GroupInvites = 2; 
		public final static int EventInvites = 3;
		public final static int Message      = 4;
		public final static int NONE         = 5;
		public final static int Shares       = 6;
	...
	{   
        ...
        */
		...
		else if(pos==3)return NotifyType.FriendRequests;
		else if(pos==4)return NotifyType.GroupInvites;
		else if(pos==5)return NotifyType.EventInvites;
		else return NotifyType.NONE;		
	}
