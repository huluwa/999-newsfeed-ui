...
import com.msocial.facebook.providers.SocialORM.FollowCol;
import com.msocial.facebook.providers.SocialORM.PhonebookCol;
import com.msocial.facebook.ui.FacebookMailActivity;
...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    {	        
        ...
        if(fortwitter == false)
        {
	        ...
	        Uri CONTENT_URI = Uri.parse("content://com.msocial.facebook.providers.SocialProvider/facebookusers");
            cursor = SqliteWrapper.query(mContext, mContentResolver,CONTENT_URI, PROJECTION_SMARTLEARNER, " name like '%"+arg+"%' " , null, null);
	        
    	    if(cursor == null || cursor.moveToFirst() == false)
    	    {
    	        CONTENT_URI = Uri.parse("content://com.msocial.facebook.providers.SocialProvider/phonebook");
        ...
        {
        	String[] args = new String[]{arg};
	        Uri CONTENT_URI = Uri.parse("content://com.msocial.facebook.providers.SocialProvider/follow");
