...
public class NotificationService implements ServiceInterface, AccountListener{
	...
	final static String ACTION="com.msocial.facebook.intent.action.FACEBOOK_NOTIFICATION_SYNC";
	final static String SERVICE="com.msocial.facebook.service.SNSService";
    SNSService             mContext;
	...
	public void rescheduleNotificationSync(boolean force)
	{
		...
		Intent i = new Intent();
		i.setClassName("com.msocial.facebook", SERVICE);
		i.setAction(ACTION);
