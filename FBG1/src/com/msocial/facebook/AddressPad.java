...
public class AddressPad extends EditText implements FilterListener {
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		if(mSelectedAddressBackground == null)
			mSelectedAddressBackground = context.getResources().getDrawable(R.drawable.address_pad_selected_address_bg);
		...
		if(mAuxiliaryButtonSelected == null)
			mAuxiliaryButtonSelected = context.getResources().getDrawable(R.drawable.address_pad_add_pressed);
		...
		styledAttrs = context.obtainStyledAttributes(attrs, com.android.internal.R.styleable.TextView);
		mTextColor = styledAttrs.getColor( com.android.internal.R.styleable.TextView_textColor, getResources().getColor(R.drawable.default_address_pad_text_color));
		mSelectedTextColor = styledAttrs.getColor( com.android.internal.R.styleable.TextView_textColorHighlight, getResources().getColor(
				R.drawable.default_address_pad_selected_text_color));
		styledAttrs.recycle();

		styledAttrs = context.obtainStyledAttributes(attrs, com.android.internal.R.styleable.AutoCompleteTextView, defStyle, 0);
		mThreshold = styledAttrs.getInt(com.android.internal.R.styleable.AutoCompleteTextView_completionThreshold, 2);
		mHintText = styledAttrs.getText(com.android.internal.R.styleable.AutoCompleteTextView_completionHint);
		mDropDownListHighlight = styledAttrs.getDrawable(com.android.internal.R.styleable.AutoCompleteTextView_dropDownSelector);
		styledAttrs.recycle();
...
//		return handled;
	 ...
	 * 
	 * @param mSnapshot mSnapshot object
	 */
	 ...
	 * 
	 * @param mSnapshot the mSnapshot saved before
	 */
	 ...
	 * 
	 * @param mSnapshot build single line string based on a mSnapshot
	 ...
	 * 
	 * @param mAuxiliaryButtonVisible true if you want add button visible, false
	 *            otherwise
	 */
	...
	public static interface OnSelectionListener {
		 ...
		 * @param mSelected true if the address string is mSelected, or false if
		 *            it is unselected
		 */
