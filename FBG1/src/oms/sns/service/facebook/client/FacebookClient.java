...
import com.msocial.facebook.ui.ActivityBase;
import com.msocial.facebook.ui.FacebookBaseActivity;
import com.msocial.facebook.ui.NetworkConnectionListener;
...
public class FacebookClient {
	...
	* @throws FacebookClientException
	 * @throws HttpException 
	*/
	public <T> T callUploadMethod( FacebookMethod<T> method, FilePart[] files, Map<String, String> params ) throws FacebookException
	{		
		RestPostMethod post = new RestPostMethod( Server.REST_URL, USER_AGENT );
		if(method.methodName.equals(FacebookMethod.Video.VIDEO_UPLOAD)){
			Log.d("facebookclient", "video upload server "+Server.VIDEO_URL);
	...
	* @throws FacebookClientException
	 * @throws HttpException 
	*/
	public <T> T callUploadMethod( FacebookMethod<T> method, FilePart[] files, Object... params ) throws FacebookException
	{
		Map<String, String> paramsMap = toMap( params );
