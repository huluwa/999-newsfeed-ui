...
import oms.sns.main.providers.SocialProvider;
...
public class SNSReceiver extends BroadcastReceiver 
{
    ...
    public void onReceive(Context context, Intent intent) 
    {
        ...
        {            
        	...
        	File files = new File("/data/data/oms.sns.main/files/");
        	if(files.exists())
        	{
        		//try 
        		//{
					//Runtime.getRuntime().exec("rm /data/data/oms.sns.main/files/* ");
	...
	private class ClearCacheThread extends Thread
	{
        @Override
        public void run() {
            File file = new File("/data/data/oms.sns.main/files/");
            deleteFile(file);
            clearDatabase();
    ...
    private void clearDatabase() {
        //check database 
        // if sns.db    
        File file = new File("/data/data/oms.sns.main/databases/sns.db");
