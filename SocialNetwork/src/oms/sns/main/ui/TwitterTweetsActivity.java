...
import oms.sns.main.ui.TwitterAccountListener.TwitterAccountManager;
import oms.sns.main.ui.adapter.SimplyStatusAdapter;
import oms.sns.main.util.SeSimplyUser;
import oms.sns.main.util.SeStatus;
...
//        handler.obtainMessage(TWEET_CREATE_UI).sendToTarget();
    ...
    public void reschedule()
	{
		...
		Intent i = new Intent();
        i.setClassName("oms.sns.main", "oms.sns.main.ui.TwitterTweetsActivity");
