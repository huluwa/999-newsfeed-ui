...
import oms.sns.main.providers.SocialORM.Trend;
import oms.sns.main.ui.AccountListener.AccountManager;
import oms.sns.main.ui.adapter.TrendsAdapter;
...
public class TwitterMainActivity extends TwitterBaseActivity {
	...
	public void reschedule()
	{
		...
		Intent i = new Intent();
        i.setClassName("oms.sns.main", "oms.sns.main.ui.TwitterMainActivity");
