...
import oms.sns.main.ui.AccountListener.AccountManager;
import oms.sns.main.ui.ActivityBase.TitleListener;
import oms.sns.main.util.StatusNotification;
...
public abstract class TwitterBaseActivity extends ActivityBase implements TitleListener,TwitterAccountListener{
	...
	protected static final String ACTION_CHECK_CONTECT ="oms.sns.main.intent.action.ACTION_CHECK_CONTECT";
     ...
     * @see oms.sns.main.ui.TwitterHandlerInterface#createHandler()
     */
