...
import oms.sns.main.providers.SocialORM.FacebookUsersCol;
import oms.sns.main.providers.SocialORM.FollowCol;
import oms.sns.main.providers.SocialORM.PhonebookCol;
...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    {	        
        ...
        if(fortwitter == false)
        {
	        ...
	        Uri CONTENT_URI = Uri.parse("content://oms.sns.main.providers.SocialProvider/facebookusers");
	        cursor = mContentResolver.query(CONTENT_URI, PROJECTION_SMARTLEARNER, " name like '%"+arg+"%' ", null, null);
	        
    	    if(cursor == null || cursor.moveToFirst() == false)
    	    {
    	        CONTENT_URI = Uri.parse("content://oms.sns.main.providers.SocialProvider/phonebook");
        ...
        {
        	String[] args = new String[]{arg};
	        Uri CONTENT_URI = Uri.parse("content://oms.sns.main.providers.SocialProvider/follow");
