package oms.sns.main.providers;
...
{
	    public static final Uri CONTENT_URI = Uri.parse("content://oms.sns.main.providers.SocialProvider");
	    ...
	    private static final String Authorities = "oms.sns.main.providers.SocialProvider";
