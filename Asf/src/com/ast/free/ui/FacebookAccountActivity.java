...
import com.ast.free.ui.adapter.FacebookCommentsAdapter;
import com.ast.free.ui.adapter.FacebookStatusAdapter;
import com.ast.free.ui.adapter.FacebookStreamAdapter;
import com.ast.free.ui.view.FacebookStreamItemView;
...
public class FacebookAccountActivity extends FacebookBaseActivity
{
   ...
   // private Button facebook_add_photo_button;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
		...
		View facebook_button_tab = findViewById(R.id.facebook_button_tab);
		if(getResources().getDisplayMetrics().density <= 1)
		{
			facebook_button_tab.setVisibility(View.GONE);
		}
