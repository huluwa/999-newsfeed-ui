...
import com.ast.free.service.internal.OmsService.OmsHandler;
...
public class FacebookLoginActivity extends Activity {
	...
	private void sendMessageToService(boolean suc) {
		Intent in = new Intent("com.ast.free.getsession");
	...
	private class GetSessionThread extends Thread
	{
		...
		public void run()
		{
			...
			handler.post( new Runnable()
            {
                public void run()
                {
                    Toast.makeText(FacebookLoginActivity.this, R.string.privacy_declaration, Toast.LENGTH_LONG).show();
                }
            });
