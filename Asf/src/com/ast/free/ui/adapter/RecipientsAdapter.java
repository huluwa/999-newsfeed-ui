...
import com.ast.free.providers.SocialORM.FollowCol;
import com.ast.free.providers.SocialORM.PhonebookCol;
import com.ast.free.ui.FacebookMailActivity;
...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    {	        
        ...
        if(fortwitter == false)
        {
	        ...
	        Uri CONTENT_URI = Uri.parse("content://com.ast.free.providers.SocialProvider/facebookusers");
            cursor = SqliteWrapper.query(mContext, mContentResolver,CONTENT_URI, PROJECTION_SMARTLEARNER, " name like '%"+arg+"%' " , null, null);
	        
    	    if(cursor == null || cursor.moveToFirst() == false)
    	    {
    	        CONTENT_URI = Uri.parse("content://com.ast.free.providers.SocialProvider/phonebook");
        ...
        {
        	String[] args = new String[]{arg};
	        Uri CONTENT_URI = Uri.parse("content://com.ast.free.providers.SocialProvider/follow");
