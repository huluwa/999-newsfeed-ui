...
public class NotificationService implements ServiceInterface, AccountListener{
	...
	final static String ACTION="com.ast.free.intent.action.FACEBOOK_NOTIFICATION_SYNC";
	final static String SERVICE="com.ast.free.service.SNSService";
    SNSService             mContext;
	...
	public void rescheduleNotificationSync(boolean force)
	{
		...
		Intent i = new Intent();
		i.setClassName("com.ast.free", SERVICE);
		i.setAction(ACTION);
	...
	private void processNotify(ArrayList<Notifications.Notification> notifications)
	{
		String text = "";
		int unread = 0;
		long lastID=0;
