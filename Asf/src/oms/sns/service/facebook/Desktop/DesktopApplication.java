...
import oms.sns.service.facebook.client.FacebookClient.SecureServer;
...
public class DesktopApplication extends FacebookApplication
{
	...
	public String getLoginUrl( String authToken, String next, boolean popup, boolean forceLogin, boolean hideSaveLoginCheckbox )
	{
	    ...
	    //UrlBuilder url = new UrlBuilder( SecureServer.LOGIN_URL, true );
		...
		url.append( "ext_perm", "email,publish_stream,read_stream,status_update,photo_upload,video_upload,offline_access,create_listing," +
				"create_event,rsvp_event,create_note,share_item,read_mailbox,sms");
