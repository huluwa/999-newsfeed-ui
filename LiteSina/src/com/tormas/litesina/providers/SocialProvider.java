...
{
	    public static final Uri CONTENT_URI = Uri.parse("content://com.tormas.litesina.providers.SocialProvider");
	    ...
	    private static final String Authorities = "com.tormas.litesina.providers.SocialProvider";
	    ...
	    private static class DatabaseHelper extends SQLiteOpenHelper 
	    {
	        ...
	        public void onCreate(SQLiteDatabase db) {
	            ...
	            try{
    	            ...
    	            db.execSQL("INSERT INTO settings (name, value) VALUES(\"follow_view_count\", \"100\");");
