...
import com.tormas.litesina.providers.SocialORM.FacebookUsersCol;
import com.tormas.litesina.providers.SocialORM.FollowCol;
import com.tormas.litesina.providers.SocialORM.PhonebookCol;
...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    {	        
...

        {
	        ...
	        Uri CONTENT_URI = Uri.parse("content://com.tormas.litesina.providers.SocialProvider/follow");
	        Cursor cursor = mContentResolver.query(CONTENT_URI, PROJECTION_SMARTLEARNER, " name like '%"+arg+"%' ", null, null);
	        return cursor;
        }
    }
