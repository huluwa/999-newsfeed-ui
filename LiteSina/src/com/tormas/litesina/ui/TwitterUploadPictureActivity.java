...
import com.tormas.litesina.ui.adapter.FacebookStatusContentAdapter;
import com.tormas.litesina.ui.adapter.FacebookStatusItem;
import com.tormas.litesina.ui.view.FacebookStatusContentItemView;
...
public class TwitterUploadPictureActivity extends StatusViewBaseActivity {
	...
	void uploadImg(long sid, String filepath,String message)
	{
		...
		twitterA.uploadPhotoSinaAsync(sid, filepath,message,new TwitterAdapter()
    	{
			 @Override public void uploadPhotoSina(long ssid, Status uploadPhoto)
			 {
    			synchronized(mLock)
		    	{
		    	    inprocess = false;
