...
import com.tormas.litesina.ui.ActivityBase.TitleListener;
import com.tormas.litesina.util.StatusNotification;
...
public abstract class TwitterBaseActivity extends ActivityBase implements TitleListener,TwitterAccountListener{
    ...
    protected static final int GET_COMMENTS       = 40000;
    protected static final int GET_COMMENTS_UI    = 40001;
    protected static final int GET_COMMENTS_END   = 40002;
	...
	//intent parameters
	public static final String STATUS_ID  ="status_id";//status id
	public static final String TWITTER_ID ="twitter_id";//user id
	public static final String TWITTER_UserName ="twitter_username";//user id
	...
	public static final String FAVORITEVIEW ="view_favorities";
	public static final String MESSAGEVIEW  ="view_messages";
	public static final String FOLLOWER_SEARCH_VIEW ="view_follower_search";
	public static final String FOLLOWER_VIEW        ="view_follower";
	public static final String FOLLOWING_VIEW       ="view_following";
	public static final String ACTION_CHECK_CONTECT ="com.tormas.litesina.intent.action.ACTION_CHECK_CONTECT";
	...
	public Twitter getTwitter()
	{
	 ...
	 protected Button      twitter_compose;
	 protected boolean     noImpactTitle=false;
	 protected boolean     noImpactAction=false;
	...
	public void setTitle(CharSequence title) {		
		...
		else
		{
		    ...
		    if(noImpactTitle == false)
		    {
			    if(headerTitle != null)
			    headerTitle.setText(title);
		    }
		    
		    if(noImpactAction == false)
		    {
     ...
     * @see com.tormas.litesina.ui.TwitterHandlerInterface#createHandler()
     */
