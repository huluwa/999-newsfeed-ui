...
import com.tormas.litesina.ui.TwitterMyAccountActivity.TwitterInfo;
import com.tormas.litesina.ui.TwitterMyAccountActivity.TwitterInfoAdapter;
import com.tormas.litesina.ui.TwitterMyAccountActivity.TwitterInfoItemView;
...
public class TwitterTweetsDetailActivity extends TwitterBaseActivity {
	            	...
	            	switch(info.type)
	            	{
	                	...
	                	{  
	                		if(user.getFriendsCount() > 0)
	                		{
		                    	...
		                    	intent.putExtra("displayname", twitterName);
	...
	private void processIntent()
	{
        ...
        else
        {
        	...
        	if(tweets != null)
        	{
                ...
                twitterID     = String.valueOf(tweets.user.id);
                statusID      = tweets.id;
	...
	{	
	    finalTitle = getString(R.string.twitter_option_reply);
	}   
	...
	private void setMainUI()
	{
		...
		if(tmp != null)
		{
			...
			if(isEmpty(tmp.original_text) == false)
		...
		public void handleMessage(Message msg) 
		{
			switch(msg.what)
			{
			    ...
			    case FOLLOW_CREATE_UI:
			    {
			    	...
			    	//0 following, 1 follower, 2 updates, 3 favorites
	            	twitterinfolist.add(new TwitterInfo(TwitterInfo.following,user.getFriendsCount(),getString(R.string.context_follow_following)));
	            	twitterinfolist.add(new TwitterInfo(TwitterInfo.follower,user.getFollowersCount(),getString(R.string.context_following_followers)));
	            	twitterinfolist.add(new TwitterInfo(TwitterInfo.updates,user.getStatusesCount(),getString(R.string.twitter_tweet_name)));
	            	twitterinfolist.add(new TwitterInfo(TwitterInfo.favorites,user.getFavouritesCount(),getString(R.string.context_status_favorite)));
